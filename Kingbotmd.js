...
break
	    ...
	    break
	    case 'ytr': case 'ytg': case 'ytsearch': {
            ...
            break
        case 'google': {
                if (!text) return reply(`Example : ${prefix + command} νιнαηgα BOT MD`)
                ...
                listMessage :{
                    ...
                    sections: [{
								...
								"rows": [
									{
										"title": "ꜱʜᴏʀᴛ ᴍᴇɴᴜ",
										"description": "වැදගත් කමාන්ඩ් ටික...",
...
And Again Me (King Nexus ) 🔥 Who Helped Assemble This Script !!!`,unicorn, [{"urlButton": {"displayText": "YOUTUBE","url": `${myweb}`}},{"urlButton": {"displayText": "GITHUB","url": `${sc}`}},{"quickReplyButton": {"displayText": "Donate","id": 'donate'}},{"quickReplyButton": {"displayText": "OWNER","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
